...
public interface BookingRepository extends JpaRepository<Booking, Long> {
	...
	List<Booking> findByStatusAndCheckInDateBetween(@Param("status") GuestStatus guestStatus,
	...
	List<Booking> findByStatusAndCheckInDateAfter(@Param("status") GuestStatus guestStatus,
			@Param("start") LocalDate start);

	@Query(value = "SELECT * FROM booking WHERE status = :status AND check_in_date < :end", nativeQuery = true)
	List<Booking> findByStatusAndCheckInDateBefore(@Param("status") GuestStatus guestStatus,

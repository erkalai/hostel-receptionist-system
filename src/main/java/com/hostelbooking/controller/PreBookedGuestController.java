...
public class PreBookedGuestController {
	...
	@PostMapping
	public String savePreBookedGues(@RequestParam String name, @RequestParam String programName,
			@RequestParam String idType, @RequestParam String mobileNumber, @RequestParam String kid,
			@RequestParam String idNumber, RedirectAttributes redioAttributes, Principal principal) {
